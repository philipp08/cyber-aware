  ...
  return (
    <div style={{ background: S.bg, color: S.text, minHeight: "100vh" }}>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 2rem", height: 60, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <div style={{ width: 30, height: 30, background: S.accent, borderRadius: 8, display: "flex", alignItems: "center", justifyContent: "center" }}>
              <Shield size={16} color={S.bg} strokeWidth={2.5} />
            </div>
            <span style={{ fontWeight: 700, fontSize: "0.95rem", letterSpacing: "-0.01em" }}>CyberAware</span>
          </div>
          <nav style={{ display: "flex", alignItems: "center", gap: 6 }}>
            {["Features", "Module", "Preise"].map(l => (
              <a key={l} href={`#${l.toLowerCase()}`} style={{ padding: "0.3rem 0.9rem", fontSize: "0.82rem", color: S.text2, textDecoration: "none", borderRadius: 100 }}>{l}</a>
            ))}
          </nav>
          <div style={{ display: "flex", gap: 8 }}>
            <Link href="/login" style={{ padding: "0.4rem 1rem", fontSize: "0.82rem", color: S.text2, textDecoration: "none", border: `1px solid ${S.border}`, borderRadius: 100 }}>
              Anmelden
            </Link>
            <Link href="/login" style={{ padding: "0.4rem 1.1rem", fontSize: "0.82rem", fontWeight: 600, background: S.accent, color: S.bg, textDecoration: "none", borderRadius: 100 }}>
              Demo starten
            </Link>
          </div>
        </div>
      ...
      <section style={{ maxWidth: 1200, margin: "0 auto", padding: "7rem 2rem 5rem" }}>
        <div style={{ display: "inline-flex", alignItems: "center", gap: 6, padding: "0.3rem 0.8rem", background: "rgba(204,255,0,0.08)", border: "1px solid rgba(204,255,0,0.2)", borderRadius: 100, fontSize: "0.72rem", fontWeight: 600, color: S.accent, letterSpacing: "0.06em", textTransform: "uppercase", marginBottom: "2rem" }}>
        ...
        <h1 style={{ fontSize: "clamp(3rem, 7vw, 6rem)", fontWeight: 800, letterSpacing: "-0.04em", lineHeight: 1.0, marginBottom: "1.5rem", maxWidth: 700 }}>
          Datensicherheit,<br />
          <em style={{ fontStyle: "italic", color: S.accent }}>die wirkt.</em>
        </h1>

        <p style={{ fontSize: "1.15rem", color: S.text2, maxWidth: 520, lineHeight: 1.6, marginBottom: "2.5rem" }}>
        ...
        <div style={{ display: "flex", gap: 12 }}>
          <Link href="/login" style={{ display: "inline-flex", alignItems: "center", gap: 6, padding: "0.75rem 1.5rem", background: S.accent, color: S.bg, fontWeight: 700, fontSize: "0.9rem", borderRadius: 100, textDecoration: "none" }}>
            Demo starten <ArrowUpRight size={16} />
          </Link>
          <Link href="/admin" style={{ display: "inline-flex", alignItems: "center", gap: 6, padding: "0.75rem 1.5rem", border: `1px solid ${S.border}`, color: S.text2, fontSize: "0.9rem", borderRadius: 100, textDecoration: "none" }}>
            Admin-Dashboard
          </Link>
        </div>
        ...
        <div style={{ display: "flex", gap: "3rem", marginTop: "5rem", paddingTop: "3rem", borderTop: `1px solid ${S.border}` }}>
          {[
            ...
            <div key={s.l}>
              ...
              <div style={{ fontSize: "0.78rem", color: S.text2, marginTop: 2 }}>{s.l}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      <section id="features" style={{ maxWidth: 1200, margin: "0 auto", padding: "4rem 2rem" }}>
        <div style={{ marginBottom: "2.5rem" }}>
          <div style={{ fontSize: "0.72rem", fontWeight: 600, color: S.text2, textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: 8 }}>Features</div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 12 }}>
          {/* Big card */}
          <div style={{ gridColumn: "span 2", background: S.surface, border: `1px solid ${S.border}`, borderRadius: 24, padding: "2.5rem", display: "flex", flexDirection: "column", justifyContent: "space-between", minHeight: 280 }}>
            <div style={{ fontSize: "2.5rem", marginBottom: "1rem" }}>🛡️</div>
            <div>
              <div style={{ fontSize: "1.3rem", fontWeight: 700, marginBottom: "0.5rem" }}>8 interaktive Module</div>
              <div style={{ color: S.text2, fontSize: "0.88rem", lineHeight: 1.6, maxWidth: 400 }}>
          ...
          <div style={{ background: S.accent, borderRadius: 24, padding: "2.5rem", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
            ...
            <div>
              <div style={{ fontSize: "1.3rem", fontWeight: 800, color: S.bg, marginBottom: "0.4rem" }}>Digitale Zertifikate</div>
          ...
          <div style={{ background: S.surface, border: `1px solid ${S.border}`, borderRadius: 24, padding: "2rem" }}>
            ...
            <div style={{ color: S.text2, fontSize: "0.83rem", lineHeight: 1.6 }}>Realistische Kampagnen mit automatischer Weiterleitung zum Schulungsmodul</div>
          </div>

          <div style={{ background: S.surface, border: `1px solid ${S.border}`, borderRadius: 24, padding: "2rem" }}>
            <div style={{ fontSize: "2rem", marginBottom: "1.5rem" }}>📊</div>
            <div style={{ fontSize: "1.1rem", fontWeight: 700, marginBottom: "0.4rem" }}>Compliance-Reports</div>
            <div style={{ color: S.text2, fontSize: "0.83rem", lineHeight: 1.6 }}>ISO-27001 & BSI Grundschutz – audit-fähige PDFs auf Knopfdruck</div>
          </div>

          <div style={{ background: S.surface2, border: `1px solid rgba(255,255,255,0.08)`, borderRadius: 24, padding: "2rem" }}>
            <div style={{ fontSize: "2rem", marginBottom: "1.5rem" }}>🌍</div>
            <div style={{ fontSize: "1.1rem", fontWeight: 700, marginBottom: "0.4rem" }}>4 Sprachen & SCORM</div>
            <div style={{ color: S.text2, fontSize: "0.83rem", lineHeight: 1.6 }}>DE, EN, FR, ES – SCORM-Export für Moodle & SAP SuccessFactors</div>
          </div>
        </div>
      </section>
      ...
      <section id="module" style={{ maxWidth: 1200, margin: "0 auto", padding: "4rem 2rem" }}>
        <div style={{ marginBottom: "2.5rem" }}>
          <div style={{ fontSize: "0.72rem", fontWeight: 600, color: S.text2, textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: 8 }}>Lernmodule</div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 8 }}>
          {[
            ...
            <Link key={m.n} href="/login" style={{ background: S.surface, border: `1px solid ${S.border}`, borderRadius: 16, padding: "1.25rem", textDecoration: "none", transition: "border-color 0.15s", display: "block" }}>
              <div style={{ fontSize: "1.8rem", marginBottom: "0.75rem" }}>{m.icon}</div>
              <div style={{ fontSize: "0.65rem", color: S.text2, marginBottom: "0.25rem", fontWeight: 500 }}>Modul {m.n}</div>
              <div style={{ fontSize: "0.88rem", fontWeight: 600, color: S.text, marginBottom: "0.5rem" }}>{m.t}</div>
              <span style={{
      ...
      <section id="preise" style={{ maxWidth: 1200, margin: "0 auto", padding: "4rem 2rem 6rem" }}>
        <div style={{ marginBottom: "2.5rem" }}>
          <div style={{ fontSize: "0.72rem", fontWeight: 600, color: S.text2, textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: 8 }}>Pricing</div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 12 }}>
          {[
            ...
            <div key={p.name} style={{
              background: p.highlight ? S.accent : S.surface,
              border: `1px solid ${p.highlight ? "transparent" : S.border}`,
              borderRadius: 24, padding: "2rem",
            }}>
              <div style={{ fontSize: "0.75rem", fontWeight: 600, color: p.highlight ? "rgba(0,0,0,0.5)" : S.text2, marginBottom: 4, textTransform: "uppercase", letterSpacing: "0.06em" }}>{p.users}</div>
              <div style={{ fontSize: "1.5rem", fontWeight: 800, color: p.highlight ? S.bg : S.text, letterSpacing: "-0.02em", marginBottom: "0.25rem" }}>{p.name}</div>
              <div style={{ marginBottom: "1.5rem" }}>
                <span style={{ fontSize: "2.5rem", fontWeight: 800, color: p.highlight ? S.bg : S.text, letterSpacing: "-0.03em" }}>{p.price}</span>
                <span style={{ fontSize: "0.85rem", color: p.highlight ? "rgba(0,0,0,0.4)" : S.text2 }}>{p.period}</span>
              </div>
              <ul style={{ listStyle: "none", marginBottom: "1.5rem" }}>
                {p.features.map(f => (
                  <li key={f} style={{ display: "flex", alignItems: "center", gap: 8, fontSize: "0.82rem", color: p.highlight ? "rgba(0,0,0,0.7)" : S.text2, marginBottom: 8 }}>
                    <CheckCircle size={13} color={p.highlight ? S.bg : "var(--green)"} strokeWidth={2.5} />
                    {f}
                  </li>
                ))}
              </ul>
              <Link href="/login" style={{ display: "block", textAlign: "center", padding: "0.65rem", background: p.highlight ? S.bg : "transparent", border: p.highlight ? "none" : `1px solid ${S.border}`, color: p.highlight ? S.accent : S.text2, fontWeight: 600, fontSize: "0.85rem", borderRadius: 100, textDecoration: "none" }}>
      ...
      <footer style={{ borderTop: `1px solid ${S.border}`, padding: "2rem", textAlign: "center" }}>
        <div style={{ display: "flex", justifyContent: "center", alignItems: "center", gap: 8, marginBottom: 8 }}>
          <div style={{ width: 22, height: 22, background: S.accent, borderRadius: 6, display: "flex", alignItems: "center", justifyContent: "center" }}>
            <Shield size={13} color={S.bg} strokeWidth={2.5} />
          </div>
          <span style={{ fontWeight: 700, fontSize: "0.85rem" }}>CyberAware</span>
        </div>
        <div style={{ fontSize: "0.75rem", color: S.text2 }}>DSGVO-konform · ISO 27001 · BSI Grundschutz · © 2024 CyberAware GmbH</div>
      </footer>
    </div>
  );
}
